        ...
        publications {
            create<MavenPublication>("release") {
                ...
                pom {
                    ...
                    url.set("https://github.com/logingithubtest/test4/")
                    ...
                    scm {
                        connection.set("scm:git:git://github.com/logingithubtest/test4.git")
                        developerConnection.set("scm:git:ssh://github.com/logingithubtest/test4.git")
                        url.set("https://github.com/logingithubtest/test4/")
                    }
                    issueManagement {
                        system.set("GitHub Issues")
                        url.set("https://github.com/logingithubtest/test4/issues")
                    }
                }
            }
        }
